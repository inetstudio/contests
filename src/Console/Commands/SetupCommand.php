...
namespace InetStudio\Contests\Console\Commands;
...
class SetupCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'inetstudio:contests:setup';
    ...
    private function initCommands(): void
    {
        $this->calls = [
            [
                ...
                'params' => [
                    '--provider' => 'InetStudio\Contests\Providers\ContestsServiceProvider',
                    '--tag' => 'migrations',
                ],
            ],
            [
            ...
            [
                ...
                'command' => 'inetstudio:contests:folders',
            ],
            [
                'type' => 'artisan',
