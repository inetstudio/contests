...
namespace InetStudio\Contests\Http\Requests\Back;
 ...
 */
class SaveContestRequest extends FormRequest implements SaveContestRequestContract
{
    /**
    ...
    public function rules(Request $request): array
    {
        ...
        return array_merge([
            ...
            'slug' => 'required|alpha_dash|max:255|unique:contests,slug,'.$request->get('contest_id'),
